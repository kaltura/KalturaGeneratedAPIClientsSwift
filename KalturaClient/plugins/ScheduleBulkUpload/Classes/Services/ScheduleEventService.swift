...
extension ScheduleEventService{
	...
	public static func addFromBulkUpload(fileData: RequestFile, bulkUploadData: BulkUploadICalJobData?) -> RequestBuilder<BulkUpload> {
		let request: RequestBuilder<BulkUpload> = RequestBuilder<BulkUpload>(service: "schedule_scheduleevent", action: "addFromBulkUpload")
