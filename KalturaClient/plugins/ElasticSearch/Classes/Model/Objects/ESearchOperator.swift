...
open class ESearchOperator: ESearchBaseItem {

	public class ESearchOperatorTokenizer: ESearchBaseItem.ESearchBaseItemTokenizer {
		...
		public var searchItems: ArrayTokenizedObject<ESearchBaseItem.ESearchBaseItemTokenizer> {
			get {
				return ArrayTokenizedObject<ESearchBaseItem.ESearchBaseItemTokenizer>(self.append("searchItems"))
			} 
		}
	}

	public var operator: ESearchOperatorType? = nil
	public var searchItems: Array<ESearchBaseItem>? = nil
