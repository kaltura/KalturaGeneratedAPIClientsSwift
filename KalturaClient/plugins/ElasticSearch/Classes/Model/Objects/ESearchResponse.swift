...
open class ESearchResponse: ObjectBase {
	...
	public class ESearchResponseTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var objects: ArrayTokenizedObject<ESearchResult.ESearchResultTokenizer> {
			get {
				return ArrayTokenizedObject<ESearchResult.ESearchResultTokenizer>(self.append("objects"))
			} 
		}
	}

	public var totalCount: Int? = nil
	public var objects: Array<ESearchResult>? = nil
