...
open class GenericDistributionProviderBaseFilter: DistributionProviderFilter {

	public class GenericDistributionProviderBaseFilterTokenizer: DistributionProviderFilter.DistributionProviderFilterTokenizer {
		...
		public var isDefaultIn: BaseTokenizedObject {
			get {
				return self.append("isDefaultIn") 
			}
		}
	...
	public var isDefaultIn: String? = nil
	public var statusEqual: GenericDistributionProviderStatus? = nil
	...
	public func setMultiRequestToken(isDefaultIn: String) {
		self.dict["isDefaultIn"] = isDefaultIn
	}
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["isDefaultIn"] != nil {
			isDefaultIn = dict["isDefaultIn"] as? String
		}
		if dict["statusEqual"] != nil {
			statusEqual = GenericDistributionProviderStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
