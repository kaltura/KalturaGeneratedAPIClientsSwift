...
open class GenericDistributionProviderActionBaseFilter: Filter {
	...
	public var genericDistributionProviderIdEqual: Int? = nil
	public var genericDistributionProviderIdIn: String? = nil
	public var actionEqual: DistributionAction? = nil
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["genericDistributionProviderIdEqual"] != nil {
			genericDistributionProviderIdEqual = dict["genericDistributionProviderIdEqual"] as? Int
		}
		if dict["genericDistributionProviderIdIn"] != nil {
			genericDistributionProviderIdIn = dict["genericDistributionProviderIdIn"] as? String
		}
		if dict["actionEqual"] != nil {
			actionEqual = DistributionAction(rawValue: (dict["actionEqual"] as? Int)!)
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(genericDistributionProviderIdEqual != nil) {
			dict["genericDistributionProviderIdEqual"] = genericDistributionProviderIdEqual!
		}
		if(genericDistributionProviderIdIn != nil) {
			dict["genericDistributionProviderIdIn"] = genericDistributionProviderIdIn!
		}
		if(actionEqual != nil) {
