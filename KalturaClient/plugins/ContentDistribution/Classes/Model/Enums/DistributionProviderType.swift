...
public enum DistributionProviderType: String {
	...
	case FREEWHEEL = "freewheelDistribution.FREEWHEEL"
	case FREEWHEEL_GENERIC = "freewheelGenericDistribution.FREEWHEEL_GENERIC"
	case FTP = "ftpDistribution.FTP"
	case FTP_SCHEDULED = "ftpDistribution.FTP_SCHEDULED"
	case HULU = "huluDistribution.HULU"
