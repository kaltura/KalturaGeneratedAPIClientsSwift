...
public final class CuePointService{
	...
	public static func updateCuePointsTimes(id: String, startTime: Int, endTime: Int?) -> RequestBuilder<CuePoint, CuePoint.CuePointTokenizer, UpdateCuePointsTimesTokenizer> {
		let request: RequestBuilder<CuePoint, CuePoint.CuePointTokenizer, UpdateCuePointsTimesTokenizer> = RequestBuilder<CuePoint, CuePoint.CuePointTokenizer, UpdateCuePointsTimesTokenizer>(service: "cuepoint_cuepoint", action: "updateCuePointsTimes")
			.setParam(key: "id", value: id)
