...
public final class PartnerCatalogItemService{
	...
	public static func delete(id: Int) -> NullRequestBuilder<DeleteTokenizer> {
		let request: NullRequestBuilder<DeleteTokenizer> = NullRequestBuilder<DeleteTokenizer>(service: "reach_partnercatalogitem", action: "delete")
			.setParam(key: "id", value: id)
