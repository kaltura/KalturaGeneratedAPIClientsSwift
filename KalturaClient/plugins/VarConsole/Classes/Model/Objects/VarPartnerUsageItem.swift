...
open class VarPartnerUsageItem: ObjectBase {

	public class VarPartnerUsageItemTokenizer: ObjectBase.ObjectBaseTokenizer {
		...
		public var combinedStorageBandwidth: BaseTokenizedObject {
			get {
				return self.append("combinedStorageBandwidth") 
			}
		}
		...
		public var dateId: BaseTokenizedObject {
			get {
				return self.append("dateId") 
			}
		}
	}
	...
	public var combinedStorageBandwidth: Double? = nil
	...
	public func setMultiRequestToken(combinedStorageBandwidth: String) {
		self.dict["combinedStorageBandwidth"] = combinedStorageBandwidth
	}
	...
	public func setMultiRequestToken(dateId: String) {
		self.dict["dateId"] = dateId
	}
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["combinedStorageBandwidth"] != nil {
			combinedStorageBandwidth = dict["combinedStorageBandwidth"] as? Double
		}
		if dict["transcodingUsage"] != nil {
			transcodingUsage = dict["transcodingUsage"] as? Double
		}
		if dict["dateId"] != nil {
			dateId = dict["dateId"] as? String
		}
	...
	public override func toDictionary() -> [String: Any] {
		...
		if(combinedStorageBandwidth != nil) {
			dict["combinedStorageBandwidth"] = combinedStorageBandwidth!
		}
