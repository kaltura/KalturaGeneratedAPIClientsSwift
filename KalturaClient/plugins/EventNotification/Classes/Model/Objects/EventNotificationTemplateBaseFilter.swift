...
open class EventNotificationTemplateBaseFilter: Filter {

	public class EventNotificationTemplateBaseFilterTokenizer: Filter.FilterTokenizer {
	...
	public var typeEqual: EventNotificationTemplateType? = nil
	public var typeIn: String? = nil
	public var statusEqual: EventNotificationTemplateStatus? = nil
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["typeEqual"] != nil {
			typeEqual = EventNotificationTemplateType(rawValue: "\(dict["typeEqual"]!)")
		}
		if dict["typeIn"] != nil {
			typeIn = dict["typeIn"] as? String
		}
		if dict["statusEqual"] != nil {
			statusEqual = EventNotificationTemplateStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
