...
open class CaptionAssetBaseFilter: AssetFilter {
	...
	public var statusEqual: CaptionAssetStatus? = nil
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["captionParamsIdEqual"] != nil {
			captionParamsIdEqual = dict["captionParamsIdEqual"] as? Int
		}
		if dict["captionParamsIdIn"] != nil {
			captionParamsIdIn = dict["captionParamsIdIn"] as? String
		}
		...
		if dict["statusEqual"] != nil {
			statusEqual = CaptionAssetStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(captionParamsIdEqual != nil) {
			dict["captionParamsIdEqual"] = captionParamsIdEqual!
		}
		if(captionParamsIdIn != nil) {
			dict["captionParamsIdIn"] = captionParamsIdIn!
		}
		if(formatEqual != nil) {
