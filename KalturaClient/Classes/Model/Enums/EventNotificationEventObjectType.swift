...
public enum EventNotificationEventObjectType: String {
	...
	case SCHEDULE_EVENT = "scheduleEventNotifications.ScheduleEvent"
	case SCHEDULE_EVENT_RESOURCE = "scheduleEventNotifications.ScheduleEventResource"
	case SCHEDULE_RESOURCE = "scheduleEventNotifications.ScheduleResource"
