...
open class IpAddressRestriction: BaseRestriction {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["ipAddressRestrictionType"] != nil {
			ipAddressRestrictionType = IpAddressRestrictionType(rawValue: (dict["ipAddressRestrictionType"] as? Int)!)
		}
		if dict["ipAddressList"] != nil {
			ipAddressList = dict["ipAddressList"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(ipAddressRestrictionType != nil) {
			dict["ipAddressRestrictionType"] = ipAddressRestrictionType!.rawValue
		}
		if(ipAddressList != nil) {
			dict["ipAddressList"] = ipAddressList!
		}
		return dict
	}
}
