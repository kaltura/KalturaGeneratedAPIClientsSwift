...
open class DirectoryRestriction: BaseRestriction {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["directoryRestrictionType"] != nil {
			directoryRestrictionType = DirectoryRestrictionType(rawValue: (dict["directoryRestrictionType"] as? Int)!)
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(directoryRestrictionType != nil) {
			dict["directoryRestrictionType"] = directoryRestrictionType!.rawValue
		}
		return dict
	}
}
