...
open class BatchJobFilterExt: BatchJobFilter {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["jobTypeAndSubTypeIn"] != nil {
			jobTypeAndSubTypeIn = dict["jobTypeAndSubTypeIn"] as? String
		}
	...
	public override func toDictionary() -> [String: Any] {
		...
		if(jobTypeAndSubTypeIn != nil) {
			dict["jobTypeAndSubTypeIn"] = jobTypeAndSubTypeIn!
		}
		return dict
	}
}
