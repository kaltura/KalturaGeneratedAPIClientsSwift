...
open class DeliveryProfileBaseFilter: Filter {

	public class DeliveryProfileBaseFilterTokenizer: Filter.FilterTokenizer {
		...
		public var streamerTypeEqual: BaseTokenizedObject {
			get {
				return self.append("streamerTypeEqual") 
			}
		}
	...
	public var streamerTypeEqual: PlaybackProtocol? = nil
	public var statusEqual: DeliveryStatus? = nil
	...
	public func setMultiRequestToken(streamerTypeEqual: String) {
		self.dict["streamerTypeEqual"] = streamerTypeEqual
	}
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["streamerTypeEqual"] != nil {
			streamerTypeEqual = PlaybackProtocol(rawValue: "\(dict["streamerTypeEqual"]!)")
		}
		if dict["statusEqual"] != nil {
			statusEqual = DeliveryStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(streamerTypeEqual != nil) {
			dict["streamerTypeEqual"] = streamerTypeEqual!.rawValue
		}
		if(statusEqual != nil) {
