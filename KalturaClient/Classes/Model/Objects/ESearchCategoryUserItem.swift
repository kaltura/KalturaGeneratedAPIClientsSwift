...
open class ESearchCategoryUserItem: ESearchAbstractCategoryItem {

	public class ESearchCategoryUserItemTokenizer: ESearchAbstractCategoryItem.ESearchAbstractCategoryItemTokenizer {
	...
	public var fieldName: ESearchCategoryUserFieldName? = nil
	public var permissionLevel: CategoryUserPermissionLevel? = nil
	public var permissionName: String? = nil
	...
	public func setMultiRequestToken(permissionName: String) {
		self.dict["permissionName"] = permissionName
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["fieldName"] != nil {
			fieldName = ESearchCategoryUserFieldName(rawValue: "\(dict["fieldName"]!)")
		}
		if dict["permissionLevel"] != nil {
			permissionLevel = CategoryUserPermissionLevel(rawValue: (dict["permissionLevel"] as? Int)!)
		}
		if dict["permissionName"] != nil {
			permissionName = dict["permissionName"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(permissionName != nil) {
			dict["permissionName"] = permissionName!
		}
		return dict
	}
}
