...
open class ESearchUserOperator: ESearchUserBaseItem {
	...
	public class ESearchUserOperatorTokenizer: ESearchUserBaseItem.ESearchUserBaseItemTokenizer {
		...
		public var searchItems: ArrayTokenizedObject<ESearchUserBaseItem.ESearchUserBaseItemTokenizer> {
			get {
				return ArrayTokenizedObject<ESearchUserBaseItem.ESearchUserBaseItemTokenizer>(self.append("searchItems"))
			} 
		}
	}
