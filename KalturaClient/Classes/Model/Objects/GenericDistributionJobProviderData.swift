...
open class GenericDistributionJobProviderData: DistributionJobProviderData {
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["resultParseData"] != nil {
			resultParseData = dict["resultParseData"] as? String
		}
		if dict["resultParserType"] != nil {
			resultParserType = GenericDistributionProviderParser(rawValue: (dict["resultParserType"] as? Int)!)
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(resultParseData != nil) {
			dict["resultParseData"] = resultParseData!
		}
		if(resultParserType != nil) {
			dict["resultParserType"] = resultParserType!.rawValue
		}
		return dict
	}
}
