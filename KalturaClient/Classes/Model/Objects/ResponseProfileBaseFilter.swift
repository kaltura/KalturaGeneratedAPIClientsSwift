...
open class ResponseProfileBaseFilter: Filter {

	public class ResponseProfileBaseFilterTokenizer: Filter.FilterTokenizer {
	...
	public var statusEqual: ResponseProfileStatus? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["statusEqual"] != nil {
			statusEqual = ResponseProfileStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
