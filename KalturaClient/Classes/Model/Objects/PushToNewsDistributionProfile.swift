...
open class PushToNewsDistributionProfile: ConfigurableDistributionProfile {
	...
	public class PushToNewsDistributionProfileTokenizer: ConfigurableDistributionProfile.ConfigurableDistributionProfileTokenizer {
		...
		public var namedItem: BaseTokenizedObject {
			get {
				return self.append("namedItem") 
			}
		}
	...
	public var namedItem: String? = nil
	...
	public func setMultiRequestToken(namedItem: String) {
		self.dict["namedItem"] = namedItem
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["namedItem"] != nil {
			namedItem = dict["namedItem"] as? String
		}
