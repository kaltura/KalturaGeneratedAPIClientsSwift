...
open class AppTokenBaseFilter: Filter {

	public class AppTokenBaseFilterTokenizer: Filter.FilterTokenizer {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["statusEqual"] != nil {
			statusEqual = AppTokenStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
