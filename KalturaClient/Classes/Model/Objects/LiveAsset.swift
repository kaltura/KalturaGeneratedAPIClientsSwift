...
open class LiveAsset: FlavorAsset {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["multicastIP"] != nil {
			multicastIP = dict["multicastIP"] as? String
		}
		if dict["multicastPort"] != nil {
			multicastPort = dict["multicastPort"] as? Int
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(multicastIP != nil) {
			dict["multicastIP"] = multicastIP!
		}
		if(multicastPort != nil) {
			dict["multicastPort"] = multicastPort!
		}
		return dict
	}
}
