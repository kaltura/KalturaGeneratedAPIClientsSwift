...
open class FlavorParamsOutput: FlavorParams {
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["flavorParamsVersion"] != nil {
			flavorParamsVersion = dict["flavorParamsVersion"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(flavorParamsVersion != nil) {
			dict["flavorParamsVersion"] = flavorParamsVersion!
		}
