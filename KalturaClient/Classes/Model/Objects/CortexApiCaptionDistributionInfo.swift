...
open class CortexApiCaptionDistributionInfo: ObjectBase {

	public class CortexApiCaptionDistributionInfoTokenizer: ObjectBase.ObjectBaseTokenizer {
	...
	public var action: CortexApiDistributionCaptionAction? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["action"] != nil {
			action = CortexApiDistributionCaptionAction(rawValue: (dict["action"] as? Int)!)
		}
		if dict["version"] != nil {
