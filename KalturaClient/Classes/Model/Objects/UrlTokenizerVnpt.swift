...
open class UrlTokenizerVnpt: UrlTokenizer {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		// set members values:
		if dict["tokenizationFormat"] != nil {
			tokenizationFormat = dict["tokenizationFormat"] as? Int
		}
		if dict["shouldIncludeClientIp"] != nil {
			shouldIncludeClientIp = dict["shouldIncludeClientIp"] as? Bool
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(shouldIncludeClientIp != nil) {
			dict["shouldIncludeClientIp"] = shouldIncludeClientIp!
		}
		return dict
	}
}
