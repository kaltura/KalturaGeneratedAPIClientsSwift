...
open class EntriesCsvJobData: MappedObjectsCsvJobData {

	public class EntriesCsvJobDataTokenizer: MappedObjectsCsvJobData.MappedObjectsCsvJobDataTokenizer {
	...
	/**  The filter should return the list of entries that need to be specified in the
	  csv.  */
	public var filter: BaseEntryFilter? = nil
