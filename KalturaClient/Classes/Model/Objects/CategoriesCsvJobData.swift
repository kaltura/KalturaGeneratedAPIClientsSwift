...
open class CategoriesCsvJobData: MappedObjectsCsvJobData {

	public class CategoriesCsvJobDataTokenizer: MappedObjectsCsvJobData.MappedObjectsCsvJobDataTokenizer {
	...
	/**  The filter should return the list of categories that need to be specified in the
	  csv.  */
	public var filter: CategoryFilter? = nil
