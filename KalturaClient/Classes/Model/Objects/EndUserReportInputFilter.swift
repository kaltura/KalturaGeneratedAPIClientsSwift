...
open class EndUserReportInputFilter: ReportInputFilter {
	...
	internal override func populate(_ dict: [String: Any]) throws {
		...
		if dict["ancestorPlaybackContext"] != nil {
			ancestorPlaybackContext = dict["ancestorPlaybackContext"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(ancestorPlaybackContext != nil) {
			dict["ancestorPlaybackContext"] = ancestorPlaybackContext!
		}
		return dict
	}
}
