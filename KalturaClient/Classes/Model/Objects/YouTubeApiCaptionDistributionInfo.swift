...
open class YouTubeApiCaptionDistributionInfo: ObjectBase {

	public class YouTubeApiCaptionDistributionInfoTokenizer: ObjectBase.ObjectBaseTokenizer {
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["action"] != nil {
			action = YouTubeApiDistributionCaptionAction(rawValue: (dict["action"] as? Int)!)
		}
		if dict["version"] != nil {
