...
open class ESearchGroupUserItem: ESearchAbstractUserItem {

	public class ESearchGroupUserItemTokenizer: ESearchAbstractUserItem.ESearchAbstractUserItemTokenizer {
	...
	public var fieldName: EsearchGroupUserFieldName? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["fieldName"] != nil {
			fieldName = EsearchGroupUserFieldName(rawValue: "\(dict["fieldName"]!)")
		}
