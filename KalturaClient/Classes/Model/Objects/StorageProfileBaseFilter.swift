...
open class StorageProfileBaseFilter: Filter {

	public class StorageProfileBaseFilterTokenizer: Filter.FilterTokenizer {
		...
		public var protocolEqual: BaseTokenizedObject {
			get {
				return self.append("protocolEqual") 
			}
		}
		
		public var protocolIn: BaseTokenizedObject {
			get {
				return self.append("protocolIn") 
			}
		}
	}
	...
	public var statusEqual: StorageProfileStatus? = nil
	public var statusIn: String? = nil
	public var protocolEqual: StorageProfileProtocol? = nil
	public var protocolIn: String? = nil
	...
	public func setMultiRequestToken(protocolEqual: String) {
		self.dict["protocolEqual"] = protocolEqual
	}
	
	public func setMultiRequestToken(protocolIn: String) {
		self.dict["protocolIn"] = protocolIn
	}
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["statusEqual"] != nil {
			statusEqual = StorageProfileStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
		if dict["statusIn"] != nil {
			statusIn = dict["statusIn"] as? String
		}
		if dict["protocolEqual"] != nil {
			protocolEqual = StorageProfileProtocol(rawValue: "\(dict["protocolEqual"]!)")
		}
		if dict["protocolIn"] != nil {
			protocolIn = dict["protocolIn"] as? String
		}
	...
	internal override func toDictionary() -> [String: Any] {
		...
		if(protocolEqual != nil) {
			dict["protocolEqual"] = protocolEqual!.rawValue
		}
		if(protocolIn != nil) {
			dict["protocolIn"] = protocolIn!
		}
		return dict
	}
}
