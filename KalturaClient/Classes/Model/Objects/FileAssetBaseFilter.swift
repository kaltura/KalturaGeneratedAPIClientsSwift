...
open class FileAssetBaseFilter: RelatedFilter {
	...
	public class FileAssetBaseFilterTokenizer: RelatedFilter.RelatedFilterTokenizer {
		...
		public var fileAssetObjectTypeEqual: BaseTokenizedObject {
			get {
				return self.append("fileAssetObjectTypeEqual") 
			}
		}
	...
	public func setMultiRequestToken(fileAssetObjectTypeEqual: String) {
		self.dict["fileAssetObjectTypeEqual"] = fileAssetObjectTypeEqual
	}
