...
open class VirtualEventBaseFilter: Filter {

	public class VirtualEventBaseFilterTokenizer: Filter.FilterTokenizer {
	...
	public var statusEqual: VirtualEventStatus? = nil
	...
	public override func populate(_ dict: [String: Any]) throws {
		...
		if dict["statusEqual"] != nil {
			statusEqual = VirtualEventStatus(rawValue: (dict["statusEqual"] as? Int)!)
		}
