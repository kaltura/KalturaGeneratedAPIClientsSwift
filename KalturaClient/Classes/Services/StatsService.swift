...
public final class StatsService{
	...
	public static func collect(event: StatsEvent) -> RequestBuilder<Bool> {
		let request: RequestBuilder<Bool> = RequestBuilder<Bool>(service: "stats", action: "collect")
	...
	public static func kmcCollect(kmcEvent: StatsKmcEvent) -> RequestBuilder<Void> {
	...
	public static func reportDeviceCapabilities(data: String) -> RequestBuilder<Void> {
	...
	public static func reportError(errorCode: String, errorMessage: String) -> RequestBuilder<Void> {
	...
	public static func reportKceError(kalturaCEError: CEError) -> RequestBuilder<CEError> {
		let request: RequestBuilder<CEError> = RequestBuilder<CEError>(service: "stats", action: "reportKceError")
