...
public final class UserScoreService{
	...
	public static func delete(gameObjectId: String, gameObjectType: GameObjectType, userId: String) -> RequestBuilder<UserScorePropertiesResponse, UserScorePropertiesResponse.UserScorePropertiesResponseTokenizer, DeleteTokenizer> {
	...
	public static func update(gameObjectId: String, gameObjectType: GameObjectType, userId: String, score: Int) -> RequestBuilder<UserScorePropertiesResponse, UserScorePropertiesResponse.UserScorePropertiesResponseTokenizer, UpdateTokenizer> {
